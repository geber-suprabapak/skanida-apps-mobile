...
const SafeColorSchemeContext = createContext<
  SafeColorSchemeContextType | undefined
>(undefined);

const COLOR_SCHEME_KEY = "user-color-scheme";

export function SafeColorSchemeProvider({
  children,
}: {
...
export function useSafeColorScheme() {
  ...
  if (context === undefined) {
    throw new Error(
      "useSafeColorScheme must be used within a SafeColorSchemeProvider",
    );
  }
  return context;
}
