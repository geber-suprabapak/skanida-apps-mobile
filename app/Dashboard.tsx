...
export default function Dashboard() {
  ...
  // Back button: only intercept when Dashboard is focused and at root of navigation stack
  useFocusEffect(
    useCallback(() => {
            ...
            <View className="px-6 pt-2 pb-6">
              <View className="flex-row items-center justify-between mb-8">
                ...
                <View className="flex-row items-center gap-2">
                  <TouchableOpacity
                    ...
                    className="w-12 h-12 rounded-full bg-secondary flex-row items-center justify-center border border-border/40"
                  >
              ...
              <View className="p-5 flex-row items-center bg-slate-900 rounded-2xl">
                ...
                >
                  <Avatar
                    size="lg"
                    fallback={displayName.charAt(0).toUpperCase() || "S"}
