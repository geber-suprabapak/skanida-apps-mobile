-- ============================================================================
-- Attendance RPC delegation for admin kiosk/manual attendance
-- Date: 2026-03-06
--
-- Mobile users may still only submit attendance for themselves. Admin users may
-- call the same RPCs for a student user_id, which keeps the Bronya manual
-- attendance kiosk compatible with the stricter mobile RPC guard.
-- ============================================================================
